        ...
        <div className=" border border-gray-300 rounded my-5 mx-2 py-3 px-4">
            ...
            <div className=" flex justify-between">
                <div className="">
                    ...
                    <h2 className=" text-2xl font-bold template2-color">{data.companyName}</h2>
                    <p className=" font-semibold m-1">{data.companyAddress}</p>
                    <p className="font-semibold">Phone: {data.companyPhone}</p>
                </div>
                <div className=" text-end">
                    <h1 className=" text-2xl font-bold template2-color">Invoice</h1>
                    <div>
                        <div>
                            <p>
            ...
            <div className=" md:flex justify-between gap-4 mb-3">
                {data.shippingName && data.shippingAddress && data.shippingPhone && (
                    <div className=" template1-bg-color2 rounded p-2 w-full">
                        <h3 className="text-xl font-bold template2-color">Shipped To</h3>
                        <p>
                ...
                <div className=" template1-bg-color2 rounded p-2 w-full">
                    <h3 className="text-xl font-bold template2-color">Billed To</h3>
                    <p>
            ...
            <div className=" mt-5">
                <Table>
                    ...
                    <TableHeader>
                        <TableRow className="template2-bg-color">
            ...
            {/* Total Section */}
            <div className=" text-end template1-bg-color2 p-3 rounded ml-auto w-1/2">
            ...
            {(data.accountName || data.accountNumber || data.accountIfscCode) && (
                <div className="my-3">
                    <h3 className=" text-lg font-bold template2-color">Bank Account Details</h3>
                    {data.accountName && (
                        <p className="mb-1">
            ...
            {data.notes && (
                <div className="mt-4 text-center">
                    <h3 className=" font-bold template2-color">Remarks</h3>
                    <p>{data.notes}</p>
                </div>
            )}
        </div>
